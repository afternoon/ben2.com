...
(define (header)
  `(header
    (nav
      (h2 ((class "font-bold mt-6 mb-10"))
        (a ((href "/"))
          ,title)))))

(define (footer)
  `(footer ((class "mt-16 pb-10"))
    (h2 ((class "font-bold mb-4")) ,title)
    (p
      ;; GitHub link
      (a ((class "!no-underline hover:text-gray-500 mr-2")
          (href "https://github.com/afternoon/")
          (target "_blank"))
      ...
      ;; Threads link
      (a ((class "!no-underline hover:text-gray-500 mr-2")
          (href "https://www.threads.net/@aftrnoon")
          (target "_blank"))
        (svg ((class "w-6 h-6 inline")
              (viewBox "0 0 448 512")
              (aria-hidden "true")
      ...
      ;; LinkedIn link
      (a ((class "!no-underline hover:text-gray-500")
          (href "https://www.linkedin.com/in/bengodfrey/")
          (target "_blank"))
        (svg ((class "w-6 h-6 inline")
              (viewBox "0 0 448 512")
              (aria-hidden "true")
...
(define (index posts)
  (page
    `(div
      (h1 ((class "text-hero/12 font-bold tracking-tighter md:mt-5 mb-15 md:mb-30"))
          "Oh hi, Iʼm Ben."
          (br)
          "Iʼm an Engineering Manager at "
          (a ((href "https://meta.com")) "Meta")
          "."
          (br)
