...
description: "The db should store link data, each link having a tally of page renders it can be used in, the tally should be demoted after 24 hours and when pages are loaded and promoted when the user clicks through."
---
