...
description: "Then, when the user is logged in, certain themes can be recommended for certain browsers and a simple sanity check can be performed before sending the page. Browser detection and what to do when we’ve identified the capabilities is a grey area that is going to need testing to get."
---
