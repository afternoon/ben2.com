...
description: "Been doing a load more Hype hacking. It's getting a touch slow though so I decided to look into profiling. There are ways to optimise though, even if it means going back to using a join for the core loops."
---
