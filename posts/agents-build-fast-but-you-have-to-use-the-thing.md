...
description: "Agents can rapidly build substantial software, but speed amplifies the cost of not using it. In this account of building a web-based DAW, Ben explains how tests, reviews, PRDs and screenshots all passed while the product drifted, and argues for continuous dogfooding, core flows and feedback from real use."
---
