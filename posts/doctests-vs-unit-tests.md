...
description: "Doctests are quite cool as small dabs here and there, but the module doesn’t have the flexibility of unit tests. In the mean time I’m considering moving all my tests back to units, which will be a pain because of the whole from django.models... boilerplate that’s required everywhere."
---
