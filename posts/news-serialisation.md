...
description: "In order to cut down on the load on those poor 56k modems long lists of shit need to be serialised into multiple pages. This is used in the query in the form &lt; id and with limit 25, that's the recordset. Combine this with a simple one page search"
---
