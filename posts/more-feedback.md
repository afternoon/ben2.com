...
description: "Coises says: Designers want and need control, but /not/ at the pixel-engineer level CSS2 so readily provides. We need control at the /logical/ level It's the relationships between blocks which are difficult to express in CSS, but the ability to define these relationships is what makes tables such a great"
---
<p>Coises says:</p>
