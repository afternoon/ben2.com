...
description: "Each link is pre-allocated a number of points, points are awarded when the link is clicked. If the post form is on the main page then demoting after page views may lead the system to slightly more load friendly."
---
