...
description: "I use a shell script run as a cron job to back up this database and the Hype database. They are organised by application, e.g. I use this to point mysqldump at two different databases."
---
