...
description: "Grep (well, GNU grep at least) has a --colour argument. Add --colour=always to your $GREP_OPTIONS and the matching word will be coloured red in output. Especially useful when grepping multiple files, great for scanability."
---
<p>Cool new thing!</p>
