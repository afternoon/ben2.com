...
description: "Hypothetical 0.2 will have features 0.1 could never dream of. The only way for this not to be a hack will be to create a new database and copy the data in. This will also alleviate the temptation to go messing around with live data."
---
