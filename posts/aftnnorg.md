...
description: "Basically, if your .htaccess has something like RewriteRule ^.*$ index.php Just make sure you add a RewriteCond to make sure this isn’t applied to the clever script that’s going to do all the work, index.php in the example."
---
