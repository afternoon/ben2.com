...
description: "I'm doing a job that involves JavaScript like nothing I've ever done before. set(key, value) functions, the object also rips the values from a named form if you want it to. The validation is a rip-off of the validation class I use in PHP, which came from a"
---
