...
description: "Take one much-maligned transformation language and throw in some functional style. I'm also limiting the scope of the work done in XML/XSLT to the text processing part, rather than moving files around and that sort of thing. Might be worth trying next time I do a CMS."
---
