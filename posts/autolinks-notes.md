...
description: " What with link click-throughs now being tracked on the Hype home page and soon to be tracked on other pages the autolinks mini-site is kind of redundant. Additionally, Hypothetical needs an Autolinks portlet and any page that deals with messages needs to run mark_links(). "
---
