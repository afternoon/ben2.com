...
description: "Choosing what defaults to use when will be really tricky, given how optimised CSS is, but it is really important will have to be addressed before it is possible to write pages at all."
---
