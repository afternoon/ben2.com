...
description: "Sync a folder to a server to which you have SSH access (and which has rsync installed). Excluding .DS_Store is a must for OS X users. rsync -cavz --exclude=\\*.swp --exclude=.DS_Store --rsh=/usr/bin/ssh folder server.com:dest"
---
